...
NUMBERS_DECLSPEC NumbersResult numbers_variable_getvalue(NumbersExtendedHandle pVariable, Numbers_double * pValue);
...
NUMBERS_DECLSPEC NumbersResult numbers_variable_setvalue(NumbersExtendedHandle pVariable, Numbers_double dValue);
...
* @return error code or 0 (success)
*/
NUMBERS_DECLSPEC NumbersResult numbers_createvariable(Numbers_double dInitialValue, NumbersExtendedHandle * pInstance);
...
* @return error code or 0 (success)
*/
NUMBERS_DECLSPEC NumbersResult numbers_getlasterror(NumbersExtendedHandle pInstance, const Numbers_uint32 nErrorMessageBufferSize, Numbers_uint32* pErrorMessageNeededChars, char * pErrorMessageBuffer, bool * pHasError);
...
* @return error code or 0 (success)
*/
NUMBERS_DECLSPEC NumbersResult numbers_releaseinstance(NumbersExtendedHandle pInstance);
...
* @return error code or 0 (success)
*/
NUMBERS_DECLSPEC NumbersResult numbers_acquireinstance(NumbersExtendedHandle pInstance);
