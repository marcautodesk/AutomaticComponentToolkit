...
NumbersResult numbers_variable_getvalue(NumbersExtendedHandle pVariable, Numbers_double * pValue)
{
	// OLD:
...
NumbersResult numbers_variable_setvalue(NumbersExtendedHandle pVariable, Numbers_double dValue)
{
	// IBase* pIBaseClass = (IBase *)pVariable;
	IBase* pIBaseClass = (IBase *)pVariable.m_hHandle;
...
// probable not necessary anymore, except for global methods
...
NumbersResult numbers_createvariable(Numbers_double dInitialValue, NumbersExtendedHandle * pInstance)
{
...
NumbersResult numbers_getlasterror(NumbersExtendedHandle pInstance, const Numbers_uint32 nErrorMessageBufferSize, Numbers_uint32* pErrorMessageNeededChars, char * pErrorMessageBuffer, bool * pHasError)
{
	IBase* pIBaseClass = nullptr;
...
NumbersResult numbers_releaseinstance(NumbersExtendedHandle pInstance)
{
	IBase* pIBaseClass = nullptr;
...
NumbersResult numbers_acquireinstance(NumbersExtendedHandle pInstance)
{
	IBase* pIBaseClass = nullptr;
