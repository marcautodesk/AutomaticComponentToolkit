...
class IBase {
public:
	static Special_FunctionTableBase m_sFunctionTable;	// needs to be populated with flat C-ABI-functions
protected:
...
public:
	static Special_FunctionTableSpecialVariable m_sFunctionTable;	// needs to be populated with flat C-ABI-functions
public:
	ISpecialVariable() {
