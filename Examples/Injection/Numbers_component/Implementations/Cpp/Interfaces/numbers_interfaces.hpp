...
// THIS does not work: as first item in memory might be (and is probably) the classes v-table
// protected:
	// void* m_pFunctionTable; // non-owning pointer to Function Table
	// this is set with m_sFunctionTable of IBase or any derived class when an instance is created
protected:
	NumbersExtendedHandle m_ExtendedHandle;
	// - non-owning pointer to this
	// - non-owning pointer to function table
	// this is set with m_sFunctionTable of IBase or any derived class when an instance is created
...
public:
	...
	IBase() {
		...
		// TODO:
		// This needs to be done in a safer way in the child classes, i.e. first cast to BaseClassInterface, then cast to void*)
...
public:
	IVariable() {
		m_ExtendedHandle.m_pFunctionTable = &m_sFunctionTable;
	}
	/**
