...
int main()
{
	try
	{
		std::string libpath = ("D:/PUBLIC/AutomaticComponentToolkit/Examples/Injection/Numbers_component/Implementations/Cpp/build/Debug"); // TODO: put the location of the Numbers-library file here.
		...
		auto pVariable = wrapper->CreateVariable(1.0);
		pVariable->SetValue(10.0);
		double val = pVariable->GetValue();
	}
