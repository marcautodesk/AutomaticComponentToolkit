...
*/
typedef NumbersResult (*PNumbersVariable_GetValuePtr) (NumbersExtendedHandle pVariable, Numbers_double * pValue);
...
* @return error code or 0 (success)
*/
typedef NumbersResult (*PNumbersVariable_SetValuePtr) (NumbersExtendedHandle pVariable, Numbers_double dValue);
...
* @return error code or 0 (success)
*/
typedef NumbersResult (*PNumbersCreateVariablePtr) (Numbers_double dInitialValue, NumbersExtendedHandle * pInstance);
...
* @return error code or 0 (success)
*/
typedef NumbersResult (*PNumbersGetLastErrorPtr) (NumbersExtendedHandle pInstance, const Numbers_uint32 nErrorMessageBufferSize, Numbers_uint32* pErrorMessageNeededChars, char * pErrorMessageBuffer, bool * pHasError);
...
* @return error code or 0 (success)
*/
typedef NumbersResult (*PNumbersReleaseInstancePtr) (NumbersExtendedHandle pInstance);
...
* @return error code or 0 (success)
*/
typedef NumbersResult (*PNumbersAcquireInstancePtr) (NumbersExtendedHandle pInstance);
...
typedef struct {
	...
	PNumbersGetSymbolLookupMethodPtr m_GetSymbolLookupMethod;	// This one potentially, too.
...
typedef struct : public sNumbersFunctionTableBase {
	PNumbersVariable_GetValuePtr m_Variable_GetValue;
	PNumbersVariable_SetValuePtr m_Variable_SetValue;
