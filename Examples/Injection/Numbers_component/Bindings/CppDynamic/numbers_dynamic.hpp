...
public:
	...
	*/
	...
	{
		Numbers_FunctionTableBase* pBaseWrapperTable = pHandle.m_pFunctionTable;
		m_sFunctionTableBase.m_AcquireInstance = (PNumbersAcquireInstancePtr)pBaseWrapperTable->m_pfnAcquireOwnership;
		m_sFunctionTableBase.m_ReleaseInstance = (PNumbersReleaseInstancePtr)pBaseWrapperTable->m_pfnReleaseOwnership;
		m_sFunctionTableBase.m_GetLastError = (PNumbersGetLastErrorPtr)pBaseWrapperTable->m_pfnAcquireOwnership;
	}
	...
	*/
	virtual ~CBase()
	{
		m_sFunctionTableBase.m_ReleaseInstance(GetHandle());
...
public:
	...
	*/
	...
	{
		Numbers_FunctionTableVariable* pVariableWrapperTable = (Numbers_FunctionTableVariable*)pHandle.m_pFunctionTable;
		m_sFunctionTableVariable.m_AcquireInstance = (PNumbersAcquireInstancePtr)pVariableWrapperTable->m_pfnAcquireOwnership;
		m_sFunctionTableVariable.m_ReleaseInstance = (PNumbersReleaseInstancePtr)pVariableWrapperTable->m_pfnReleaseOwnership;
		m_sFunctionTableVariable.m_GetLastError = (PNumbersGetLastErrorPtr)pVariableWrapperTable->m_pfnAcquireOwnership;

		m_sFunctionTableVariable.m_Variable_GetValue = (PNumbersVariable_GetValuePtr)pVariableWrapperTable->m_pfnGetValue;
		m_sFunctionTableVariable.m_Variable_SetValue = (PNumbersVariable_SetValuePtr)pVariableWrapperTable->m_pfnSetValue;
	}
	...
	*/
	inline void CWrapper::ReleaseInstance(CBase * pInstance)
	{
		...
		// TODO change this to use a member-function
